...
type mockservice struct {
	MockPediente         []service.PendienteResumen
...
func (self mockservice) ObtenerListaPendientes() ([]service.PendienteResumen, error) {
...
func TestListaPendiente(t *testing.T) {
	...
	var pedientes []service.PendienteResumen

	for i := range 10 {
		newPendiente := service.PendienteResumen{
			ID:          i,
